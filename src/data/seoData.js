export const siteSEO = {
  // General Site SEO
  siteMetadata: {
    title: 'Qawi Najd - شركة قوي نجد للهندسة والاستشارات',
    description:
      'شركة رائدة في مجال الهندسة والاستشارات، نقدم خدمات متكاملة في التصميم المعماري، الهندسة المدنية، وإدارة المشاريع',
    keywords: 'هندسة, استشارات, تصميم معماري, هندسة مدنية, إدارة مشاريع, قوي نجد, Qawi Najd',
  ...
  blogPageSEO: {
    ar: {
      title: 'المدونة - مقالات وأخبار في مجال الهندسة والاستشارات | قوي نجد',
      description:
      ...
      keywords:
        'مقالات هندسية, أخبار هندسة, تصميم معماري, هندسة مدنية, إدارة مشاريع, مدونة قوي نجد',
      ogTitle: 'المدونة - مقالات وأخبار في مجال الهندسة والاستشارات | قوي نجد',
      ogDescription:
        'اكتشف أحدث المقالات والأخبار في مجال الهندسة والاستشارات. نقدم محتوى متخصص في التصميم المعماري، الهندسة المدنية، وإدارة المشاريع',
